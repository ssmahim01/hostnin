import type { DomainFeature } from "@/types/domain-feature";
...
export const domainFeatures: DomainFeature[] = [
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Domain Privacy Illustration",
      width: 1080,
      height: 1080,
    },
  },
  {
    title: "Move anytime, anywhere",
    description:
      "We safeguard not only your confidentiality but also your right to remain here. With our full domain control panel, you can go anywhere, at any time, with a single click. Being with us is not restricted in any way. Take complete control of your domains and ensure the security of your website. We have no restrictions on renewing with us, and it will be valid until the last hour of the expiration date.",
    image: {
