...
export const webHostingData: PricingPlan[] = [
  {
    ...
    icon: "basic",
    description:
      "Perfect for personal blogs, portfolio sites, or small business websites",
    features: WebCreateFeatures("5 GB", "Super Fast Website Speed", "2"),
    expandedFeatures: {
      primary: [
        {
...

  {
    ...
    savingsText: "Save ৳6,393 with Free Plan",
    buttonText: "Add to Cart",
    infoText: "৳2,595/year when you renew",
    icon: "basic",
    description:
      "Perfect for personal blogs, portfolio sites, or small business websites",
  },
  {
    ...
    infoText: "৳3,595/year when you renew",
    icon: "starter",
    description:
      "Ideal for multiple sites with storage, WordPress & Laravel features",
  },
  {
    ...
    badge: "Most Popular",
    savingsText: "Save ৳11,493 with Free Plan",
    buttonText: "Add to Cart",
    infoText: "৳6,595/year when you renew",
    icon: "pro",
    description: "Best solution for eCommerce & product landing page websites",
  },
  {
    ...
    savingsText: "Save ৳19,993 with Free Plan",
    buttonText: "Add to Cart",
    infoText: " ৳9,595/year when you renew",
    icon: "ultimate",
    description:
      "Great for businesses with high traffic and focused on advertising",
  },
