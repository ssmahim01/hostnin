...
export default function QuestionsSection() {
  return (
    <Card className="p-0 mt-10 max-w-[75rem] mx-auto bg-gradient-to-r from-blue-950 to-blue-800 text-white rounded-lg shadow-lg overflow-hidden">
      <CardContent className="container mx-auto p-10 flex flex-col md:flex-row items-center justify-around gap-6">
