...
export default function JoinHostingSection() {
  return (
    <section className="w-full flex justify-center items-center py-8 px-2">
      <div className="w-full max-w-7xl rounded-2xl shadow-lg dark:bg-blue-700/10 bg-blue-800 px-6 py-12 flex flex-col items-center">
          ...
          {stats.map((item, idx) => (
            ...
            >
              <div className="flex items-center justify-center mb-4">
                <span className="w-20 h-20 rounded-full bg-blue-500 bg-opacity-20 flex items-center justify-center shadow-lg">
