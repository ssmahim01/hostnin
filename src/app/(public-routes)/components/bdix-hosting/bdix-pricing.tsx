...
import { bdixHostingData } from "@/data/bdix-pricing";
...
const planLinks = {
  ...
  yearly: {
    ...
    ultimate:
      "https://my.hostnin.com/index.php/store/bdix-hosting/ultimate?billingcycle=annually",
  },
};

export default function BdixHostingPricing() {
              ...
              <div className="flex flex-col justify-between px-4 sm:px-6 py-4 sm:py-6 w-full h-full">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-300 dark:to-gray-200 bg-clip-text text-transparent">
                      {plan.title}
                    </h3>
                  </div>
