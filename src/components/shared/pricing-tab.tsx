    ...
    <div className="pt-10 md:pb-0 pb-5">
      ...
      <div className="px-3">
        <ScrollArea className="w-full">
          <div className="flex gap-4 items-center justify-start mx-auto w-max rounded-full border-2 border-gray-200 dark:border-gray-700 shadow bg-gradient-to-r from-white/60 via-white/40 to-white/60 dark:from-gray-800/60 dark:via-gray-900/40 dark:to-gray-800/60 backdrop-blur-md p-2 mb-4">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                className={`
