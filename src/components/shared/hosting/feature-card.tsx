...
export default function FeatureCard({
  ...
  return (
    <div className="relative bg-accent rounded-lg shadow-xl p-4 sm:p-6 lg:p-8 flex-1 min-w-0 flex flex-col justify-between overflow-hidden font-[Mulish,sans-serif]">
      <div className="flex items-center justify-between mb-3 sm:mb-4 relative z-10 w-full">
        {/* Main icon from props */}
        <span className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-white shadow-lg flex-shrink-0 hover:scale-105 hover:shadow-lg transition-all duration-500 ease-in-out">
          <Image
            alt={title}
            src={iconSrc}
            width={64}
